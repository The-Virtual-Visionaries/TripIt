                ...
                "Morning": [
                    {
                        ...
                        "description": "Visit the Australian National Maritime Museum to explore the history of Australia's relationship with the sea."
                    }
                ],
                "Afternoon": [
                    {
                        "activity_type": "Shopping",
                        "description": "Visit the Queen Victoria Building, a heritage-listed shopping center in the heart of Sydney."
                    }
                ],
                "Night": [
                    {
                        "activity_type": "Skyscrapers",
                        "description": "Take a tour of the Sydney Tower Eye, the tallest building in Sydney, for a 360-degree view of the city."
                    }
                ]
            },
            {
                ...
                "Morning": [
                    {
                        ...
                        "description": "Take a walk in the Royal Botanic Garden, a 30-hectare garden with over 7,500 species of plants."
                    }
                ],
                "Afternoon": [
                    {
                        "activity_type": "Theme Parks",
                        "description": "Visit Luna Park, a historic amusement park with rides, games, and carnival attractions."
                    }
                ],
                "Night": [
                    {
                        "activity_type": "Historical Architectures",
                        "description": "Take a tour of the Sydney Opera House, a UNESCO World Heritage Site and one of the most iconic buildings in the world."
                    }
                ]
            }
        ];
